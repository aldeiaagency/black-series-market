    ...
    return (
      <div className="flex flex-col items-center text-center py-6">
        ...
        <p className="text-xs text-bsm-text-muted max-w-[240px]">
          El concesionario recibirá tu solicitud con el contexto completo y te responderá en breve.
        </p>
      </div>
    )
  }
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
      ...
      <div className="flex items-start gap-2 pt-1">
        ...
        <p className="text-[10px] text-bsm-text-muted leading-relaxed">
          Tu solicitud se enviará al dealer con el contexto necesario para responder mejor.
