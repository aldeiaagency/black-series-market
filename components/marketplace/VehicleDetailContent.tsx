  ...
  return (
    <div className="max-w-screen-2xl mx-auto px-6 lg:px-12 pt-28 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        {/* ──────────────── RIGHT COLUMN (sticky + independent scroll) ──────────────── */}
        <div className="lg:col-span-4 self-start sticky top-24 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 6rem)' }}>
              ...
              <>
                ...
                <div className="bg-surface border border-bsm-border p-6">
                  ...
                  <p className="text-xs text-bsm-text-muted mb-5">
                    Cuéntanos qué necesitas saber. El vendedor recibirá tu consulta con toda la información para responderte bien.
                  </p>
                  <QualifiedLeadForm
