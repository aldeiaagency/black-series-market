        ...
        {requests.map(req => {
          ...
          return (
            <button
              ...
              className={`w-full text-left border bg-surface p-5 hover:border-gold/40 transition-colors ${
                isNew && isElite ? 'border-gold/30' : 'border-bsm-border'
              }`}
            >
              {/* Row 1: badges + age */}
              <div className="flex items-center justify-between gap-3 mb-3 flex-wrap">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {isNew && isElite && (
                    <span className="text-[10px] border border-gold/40 bg-gold/5 px-2 py-0.5 text-gold">
        ...
        <div className="pointer-events-auto w-full max-w-lg bg-[#0A0A0A] border border-bsm-border flex flex-col max-h-[90vh]">
          ...
          <div className="overflow-y-auto flex-1 p-6 space-y-6">
              ...
              <div className="space-y-2.5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a
                    ...
                    className="text-sm text-bsm-text-secondary hover:text-gold flex items-center gap-1.5 transition-colors"
            ...
            {isNew && isElite && (
              <div className="border-t border-bsm-border pt-4">
                <span className="text-[10px] border border-gold/40 bg-gold/5 px-3 py-1.5 text-gold">
          ...
          <div className="border-t border-bsm-border p-6 flex-shrink-0">
            <a
              ...
              className="block w-full text-center text-sm border border-gold/40 px-6 py-3 text-gold hover:bg-gold/5 transition-colors"
            >
              Tengo este vehículo →
            </a>
