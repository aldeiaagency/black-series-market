...
const CATEGORY_VALUES = ['scooter_premium']
...
export default async function MotosScooterPage() {
  ...
  const faqItems = buildCategoryFaqItems(MOTO_CATEGORY_FAQ.scooter, stats, esGroupThousands)
  ...
  return (
    ...
    <FaqSection items={faqItems} heading="Preguntas frecuentes sobre scooters premium" eyebrow="Scooters premium" />
    <RelatedCategories categories={MOTO_CATEGORY_RELATIONS.scooter} brands={brandStock} />
    </>
  )
}
