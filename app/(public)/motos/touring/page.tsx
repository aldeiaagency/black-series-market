...
export default async function MotosTouringPage() {
  ...
  const faqItems = buildCategoryFaqItems(MOTO_CATEGORY_FAQ.touring, stats, esGroupThousands)
  ...
  return (
    ...
    <FaqSection items={faqItems} heading="Preguntas frecuentes sobre motos touring y sport touring" eyebrow="Touring y adventure" />
    <RelatedCategories categories={MOTO_CATEGORY_RELATIONS.touring} brands={brandStock} />
    </>
  )
}
