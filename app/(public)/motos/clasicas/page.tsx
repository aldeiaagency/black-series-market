...
const CATEGORY_VALUES = ['clasicas_youngtimers']
...
export default async function MotosClasicasPage() {
  ...
  const faqItems = buildCategoryFaqItems(MOTO_CATEGORY_FAQ.clasicas, stats, esGroupThousands)
  ...
  return (
    ...
    <FaqSection items={faqItems} heading="Preguntas frecuentes sobre motos clásicas y youngtimers" eyebrow="Clásicas y youngtimers" />
    <RelatedCategories categories={MOTO_CATEGORY_RELATIONS.clasicas} brands={brandStock} />
    </>
  )
}
