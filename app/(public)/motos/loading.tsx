// Loading boundary de App Router para /motos y sus landings de categoría (que no
// tienen loading.tsx propio). MotosPage es un Server Component: esto es lo único
...
export default function MotosLoading() {
  return (
    <div className="max-w-screen-2xl mx-auto px-6 lg:px-12 pt-28 pb-20">
      <div className="mb-8">
        ...
        <h1 className="section-title mb-3">Motos premium</h1>
