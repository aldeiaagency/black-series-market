// Loading boundary de App Router para /motos/[slug]. Más específico que
// app/(public)/motos/loading.tsx (que solo encaja con el grid del catálogo) y tiene
...
// Misma forma que coches/[slug]/loading.tsx: VehicleDetailContent se comparte entre
// ambos tipos de vehículo, así que el layout real es idéntico.
export default function MotoDetailLoading() {
  return (
