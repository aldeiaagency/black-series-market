...
const SERVICES_LABELS: Record<string, string> = {
  ...
  trade_in:       'Aceptan vehículos',
  warranty:       'Garantía',
  transport_nat:  'Transporte nacional',
  transport_intl: 'Transporte internacional',
  own_workshop:   'Taller propio',
  detailing:      'Detailing',
...
export default async function DealerPage({ params, searchParams }: PageProps) {
  ...
  const services    = (dealer as any).services?.filter((s: string) => s in SERVICES_LABELS) || []
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
              ...
              <div className="lg:col-span-2">
                ...
                {specialties.length > 0 && (
                  <div className={services.length > 0 ? 'mb-6' : ''}>
