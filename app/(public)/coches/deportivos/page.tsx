...
const CATEGORY_VALUES = ['deportivos', 'superdeportivos']
...
export default async function CochesDeportivosPage() {
  ...
  const faqItems = buildCategoryFaqItems(CAR_CATEGORY_FAQ.deportivos, stats, esGroupThousands)
  ...
  return (
    ...
    <FaqSection items={faqItems} heading="Preguntas frecuentes sobre deportivos y superdeportivos" eyebrow="Deportivos y superdeportivos" />
    <RelatedCategories categories={CAR_CATEGORY_RELATIONS.deportivos} brands={brandStock} />
    </>
  )
}
