...
const CATEGORY_VALUES = ['clasicos']
...
export default async function CochesClasicosPage() {
  ...
  const faqItems = buildCategoryFaqItems(CAR_CATEGORY_FAQ.clasicos, stats, esGroupThousands)
  ...
  return (
    ...
    <FaqSection items={faqItems} heading="Preguntas frecuentes sobre coches clásicos y youngtimers" eyebrow="Clásicos y youngtimers" />
    <RelatedCategories categories={CAR_CATEGORY_RELATIONS.clasicos} brands={brandStock} />
    </>
  )
}
