    ...
    <div className="p-8">
      ...
      <div className="mb-8">
        <div className="flex items-start justify-between gap-4 mb-4">
          ...
          {isElite ? (
            <span className="text-[10px] text-gold border border-gold/30 bg-gold/5 px-3 py-1.5 uppercase tracking-widest flex-shrink-0">
        ...
        {!isElite && (
          <div className="border border-bsm-border bg-surface p-4 flex items-center gap-3">
            <div className="w-0.5 h-10 bg-gold/40 flex-shrink-0" />
