    ...
    <div className="min-h-screen bg-[#050505] flex items-center justify-center px-6">
      <div className="max-w-xl w-full text-center">
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          <div className="h-px w-12 bg-[#C6A64B]/40" />
          <span className="text-[10px] text-[#C6A64B]/60 tracking-[0.3em] uppercase">404</span>
          <div className="h-px w-12 bg-[#C6A64B]/40" />
        </div>
        ...
        <div className="border-t border-[#141414] pt-8 flex flex-wrap justify-center gap-x-6 gap-y-2 text-xs text-[#5A5A5A]">
          <Link href="/dealers" className="hover:text-[#C6A64B] transition-colors">Showrooms</Link>
          <Link href="/marcas" className="hover:text-[#C6A64B] transition-colors">Marcas</Link>
          <Link href="/vehiculos-a-la-carta" className="hover:text-[#C6A64B] transition-colors">Vehículos a la carta</Link>
          <Link href="/guias" className="hover:text-[#C6A64B] transition-colors">Guías</Link>
          <Link href="/contacto" className="hover:text-[#C6A64B] transition-colors">Contacto</Link>
        </div>
